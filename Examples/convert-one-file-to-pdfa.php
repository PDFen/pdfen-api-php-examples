...
/* This example shows how to convert files to PDF/A. Just change the file you would like to convert. Check also ./ExampleFiles for example files */
...
$aFileInfo['extension'] = 'pdf'; /* Set the extension */
$aFileInfo['source_path'] =  __DIR__ . '/ExampleFiles/1.pdf'; /* Absolute path to your source file. */
...
/* 3c. Set PDF/A */
$aOptions = $oApi->setPDFA($aSession,$aOptions,'pdfa');
...
echo '<h2>Finished</h2>';
echo 'Converting the file ' . $aFileInfo['file_name_or_title'] . ' to PDF/A finished successful<br/>';
